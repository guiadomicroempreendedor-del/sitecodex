...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const text = `*Novo Lead via Site (LITECODE)*\n\n` +
                 `*Nome:* ${formData.name}\n` +
    ...
    <section id="contact" className="py-20 relative bg-lite-dark border-t border-lite-surface/50">
        <div className="container mx-auto px-4 max-w-4xl">
            <div className="text-center mb-12">
                <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-4 uppercase">Orçamento Rápido</h2>
                <p className="font-sans text-lite-metal max-w-xl mx-auto text-lg">
                    Preencha os dados abaixo para iniciar seu atendimento prioritário via WhatsApp.
                </p>
            </div>
            ...
            <div className="bg-lite-surface p-6 md:p-12 relative shadow-2xl" style={{
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="pt-4">
                        ...
                        <p className="text-center font-sans text-lite-metal text-xs mt-4">
